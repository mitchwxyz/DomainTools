...
@click.option('--show-all', is_flag=True, help='Show all results including unresolved domains')
def enumerate_subdomains(url: str | None = None, wordlist: str | None = None, show_all: bool = False):
    """
