...
class SubdomainEnumerator:
    ...
    def setup_subdomain_list(self):
        ...
        if config_path:
            ...
            self.wordlist_path = Path(__file__).parent.parent / "wordlists" / "subdomains.txt"

        if not self.wordlist_path.exists():
            raise FileNotFoundError(f"Subdomain wordlist not found at {self.wordlist_path}")
    ...
    def enumerate_subdomains(self, base_url: str, show_all: bool = False) -> dict[str, str]:
